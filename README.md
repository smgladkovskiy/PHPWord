# PHPWord - OpenXML - Read, Write and Create Word documents in PHP [![Build Status](https://travis-ci.org/RLovelett/PHPWord2.png?branch=master)](https://travis-ci.org/RLovelett/PHPWord2)
